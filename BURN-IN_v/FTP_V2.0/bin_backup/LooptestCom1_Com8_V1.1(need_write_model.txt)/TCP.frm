...
'    End If
'
''''If txtMappingModel.Text = "SW5001" Or txtMappingModel.Text = "STW-601C" Then
''''    CmdSendBeg_Click (0)
'''''    CmdSendBeg_Click (1)
''''
''''    cmdContotal.Enabled = False
...
''''    End If
''''End If
''''If txtMappingModel.Text = "SW5002" Or txtMappingModel.Text = "STW-602C" Or txtMappingModel.Text = "EW5302" Or txtMappingModel.Text = "SE5302" Or txtMappingModel.Text = "CS512" Or txtMappingModel.Text = "MG512" Or txtMappingModel.Text = "Xport512" Then
''''
''''
...
If txtMappingModel.Text = "SE6516" Or txtMappingModel.Text = "SE5516" Or txtMappingModel.Text = "SE5516-IDE" Then
...
Private Sub Timer1_Timer()
    ...
    tmpstr = tmpstr & Winsock1(1).State  '====> for txtStatus 1
    txtStatus = tmpstr
